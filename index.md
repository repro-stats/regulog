...
of authoring validation documents from scratch — a process that
typically takes weeks of internal effort — your team runs three commands
and receives a complete, signed qualification record:
...
Each protocol is self-contained and produces a pass/fail summary against
